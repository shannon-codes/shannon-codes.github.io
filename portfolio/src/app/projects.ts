export const projects = [
  {
    ...
    description: 'The Yoga Learning Assistant is a web platform that provides real-time feedback on live webcam capture. The application live detects 17 body joints of the user in 2D space and compares it to the position of the instructor on the yoga video. ',
    tech: 'React · PoseNet · TensorFlow.js · React · Bootstrap · Node.js · MongoDB',
    ...
    awards:[' 1st Place SDNE Capstone Winner', ' 1st Place Sheridan Student Experience Award']
  },
  {
    id: 2,
    name: 'Uplift',
    ...
    description: 'Designed this website at an RBC hackathon and worked with new people. The purpose is for RBC Small business owners to connect with free mini-mentorships for brainstorming over 1-hour calls. RBC mentors are experts beyond banking, coming from departments of technology, marketing, human resources, and management.',
    tech: 'Angular 8 · TypeScript · Routing · Bootstrap · CSS',
  ...
  }, 
  {
    ...
    tech: 'Java Spring Boot · H2 database · MySQL · JPA · ThymeLeaf · Bootstrap · CSS'
  },
  {
    id: 5,
